...
<head>
    ...
    <style>
        ...
        .Status-Badge[data-status="En progreso"] { background: #2196F3; }
        .Status-Badge[data-status="Abandonado"] { background: #607D8B; }
                ...
                <div class="menu-content">
                    ...
                    <div class="submenu">
                        ...
                        <div class="submenu-content">
                            <?php
                            $generos = $conn->query("SELECT nombre FROM generos ORDER BY nombre");
    ...
    function loadDirectoryPage(pagina = 1) {
        ...
        fetch(`ajax_filtrar_directorio.php?${params.toString()}`)
            ...
            .catch(error => {
                ...
                document.getElementById('directory-results').innerHTML = '<div class="error">Error al cargar el contenido. Por favor, inténtalo de nuevo.</div>';
            });
    }
